...
})(PS["CanvasExtra"] = PS["CanvasExtra"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["CanvasExtra"] = $PS["CanvasExtra"] || {};
  var exports = $PS["CanvasExtra"];
  var $foreign = $PS["CanvasExtra"];
  exports["getFillStyle"] = $foreign.getFillStyle;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["MoonLander"] = $PS["MoonLander"] || {};
  var exports = $PS["MoonLander"];
  var CanvasExtra = $PS["CanvasExtra"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Data_Array = $PS["Data.Array"];
  ...
  var GameOver = (function () {
      function GameOver(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      GameOver.create = function (value0) {
          return function (value1) {
              return new GameOver(value0, value1);
          };
      };
      return GameOver;
  })();
  ...
  var tryLoadImageAff = function (path) {
      var wrappedFn = function (done) {
          return function __do() {
              Graphics_Canvas.tryLoadImage(path)(function (maybeImage) {
                  if (maybeImage instanceof Data_Maybe.Just) {
                      return done(new Data_Either.Right(maybeImage.value0));
                  };
                  if (maybeImage instanceof Data_Maybe.Nothing) {
                      return done(new Data_Either.Left(Effect_Exception.error("Could not load " + path)));
                  };
                  throw new Error("Failed pattern match at MoonLander (line 446, column 44 - line 448, column 67): " + [ maybeImage.constructor.name ]);
              })();
              return Data_Monoid.mempty(Effect_Aff.monoidCanceler);
          };
      };
      return Effect_Aff.makeAff(wrappedFn);
  };
  var mkColor = function (r) {
      return function (g) {
          return function (b) {
              return "rgb(" + (Data_Int.toStringAs(Data_Int.decimal)(r) + ("," + (Data_Int.toStringAs(Data_Int.decimal)(g) + ("," + (Data_Int.toStringAs(Data_Int.decimal)(b) + ")")))));
          };
      };
  };
  var initialGame = {
          ...
          return function (x) {
              return function (y) {
                  return function (color) {
                      return function (bkcolor) {
                          return function (bold) {
                              var positions = Data_Functor.map(Data_Functor.functorArray)(function (j) {
                                  var boldL = bold * (Data_Int.toNumber(j) / Data_Int.toNumber(4));
                                  return Data_Functor.map(Data_Functor.functorArray)(function (i) {
                                      var theta = ((2.0 * $$Math.pi) / Data_Int.toNumber(16)) * Data_Int.toNumber(i);
                                      return {
                                          x: boldL * $$Math.cos(theta),
                                          y: boldL * $$Math.sin(theta)
                                      };
                                  })(Data_Array.range(0)(16 - 1 | 0));
                              })(Data_Array.range(0)(4 - 1 | 0));
                              var color_ = CanvasExtra.getFillStyle(ctx);
                              return function __do() {
                                  Graphics_Canvas.setFillStyle(ctx)(color)();
                                  Effect.foreachE(positions)(function (rounds) {
                                      return Effect.foreachE(rounds)(function (p) {
                                          return Graphics_Canvas.fillText(ctx)(text)(x + p.x)(y + p.y);
                                      });
                                  })();
                                  Graphics_Canvas.setFillStyle(ctx)(bkcolor)();
                                  Graphics_Canvas.fillText(ctx)(text)(x)(y)();
                                  Graphics_Canvas.setFillStyle(ctx)(color_)();
                                  return Data_Unit.unit;
                              };
                          };
                      };
  ...
  var drawRocket = function (ctx) {
      return function (rocket_src) {
                          ...
                          return function (angle) {
                              return function __do() {
                                  ...
                                  Graphics_Canvas.translate(ctx)({
                                      translateX: left + w / 2.0,
                                      translateY: top + h / 2.0
                                  })();
                                  Graphics_Canvas.rotate(ctx)((angle / 360.0) * (2.0 * $$Math.pi))();
                                  Graphics_Canvas.drawImage(ctx)(rocket_src)(0.0 - w / 2.0)(0.0 - h / 2.0)();
          ...
          return function (v) {
              if (v instanceof Init) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Bind.bind(Effect_Aff.bindAff)(tryLoadImageAff("images/rocket.png"))(function (rocket_src$prime) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(rocket_src$prime);
                      })))(function (rocket_src) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $42.images = (function () {
                                  var $39 = {};
                                  for (var $40 in st.images) {
                                      if ({}.hasOwnProperty.call(st.images, $40)) {
                                          $39[$40] = st["images"][$40];
                                      };
                                  };
                                  $39.rocket = new Data_Maybe.Just(rocket_src);
                                  return $39;
                              })();
                              return $42;
                          }))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(function (v1) {
                                  return function __do() {
                                      var x = Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(Effect_Random.randomInt(1)(s.canvas.width - 2 | 0))();
                                      var y = Data_Functor.map(Effect.functorEffect)(Data_Int.toNumber)(Effect_Random.randomInt(1)(s.canvas.height - 2 | 0))();
                                      return {
                                          x: x,
                                          y: y
                                      };
                                  };
                              })(Data_Array.range(1)(20))))(function (stars) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                      var $45 = {};
                                      for (var $46 in st) {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(Draw.value))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                  return Halogen_Query_EventSource.eventListenerEventSource(dictMonadAff)(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                                      var $123 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create(sid));
                                                      return function ($124) {
                                                          return $123(Web_UIEvent_KeyboardEvent.fromEvent($124));
                                                      };
                                                  })());
                                              }))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                      return Halogen_Query_EventSource.eventListenerEventSource(dictMonadAff)(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                                          var $125 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create(sid));
                                                          return function ($126) {
                                                              return $125(Web_UIEvent_KeyboardEvent.fromEvent($126));
                                                          };
                                                      })());
                                                  }))(function () {
              ...
              if (v instanceof HandleKeyDown) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      var $$char = Web_UIEvent_KeyboardEvent.key(v.value1);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $48 = $$char === " ";
                          if ($48) {
                              if (s.game.gameStatus instanceof Playing) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                      ...
                                      $53.game = (function () {
                                          var $50 = {};
                                          for (var $51 in s.game) {
                                              if ({}.hasOwnProperty.call(s.game, $51)) {
                                                  $50[$51] = s["game"][$51];
                                              };
                                          };
                                          $50.keyFlag = true;
                              ...
                              if (s.game.gameStatus instanceof Opening) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                      var $59 = {};
                                      for (var $60 in st) {
                                      ...
                                      $59.game = (function () {
                                          var $56 = {};
                                          for (var $57 in s.game) {
                                              if ({}.hasOwnProperty.call(s.game, $57)) {
                                                  $56[$57] = s["game"][$57];
                                              };
                                          };
                                          $56.gameStatus = Playing.value;
                                          $56.keyFlag = true;
                                          return $56;
                                      })();
                                      return $59;
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(Draw.value))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.fork(doLoop(dictMonadAff)(dictMonadAff.MonadEffect0())))(function () {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          });
                                      });
                                  });
                              };
                              if (s.game.gameStatus instanceof GameOver) {
                                  if (s.game.gameStatus.value1 instanceof Waiting) {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                  };
                                  if (s.game.gameStatus.value1 instanceof Ready) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                          var $63 = {};
                                          for (var $64 in st) {
                                  ...
                                  throw new Error("Failed pattern match at MoonLander (line 253, column 11 - line 257, column 32): " + [ s.game.gameStatus.value1.constructor.name ]);
                              };
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          };
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          ...
                          if ($70) {
                              if (s.game.gameStatus instanceof Playing) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                      ...
                                      $75.game = (function () {
                                          var $72 = {};
                                          for (var $73 in s.game) {
                                              if ({}.hasOwnProperty.call(s.game, $73)) {
                                                  $72[$73] = s["game"][$73];
                                              };
                                          };
                                          $72.keyFlag = false;
              ...
              if (v instanceof Draw) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Functor["void"](Effect.functorEffect)(function __do() {
                          var v1 = Graphics_Canvas.getCanvasElementById("hidden_canvas")();
                          if (v1 instanceof Data_Maybe.Just) {
                              var ctx = Graphics_Canvas.getContext2D(v1.value0)();
                              Graphics_Canvas.setFillStyle(ctx)("#000")();
                              Graphics_Canvas.fillPath(ctx)(Graphics_Canvas.rect(ctx)({
                                  x: 0.0,
                                  y: 0.0,
                                  width: Data_Int.toNumber(s.canvas.width),
                                  height: Data_Int.toNumber(s.canvas.height)
                              }))();
                              Graphics_Canvas.setFillStyle(ctx)("#FFF")();
                              Effect.foreachE(s.stars)(function (position) {
                              ...
                              Graphics_Canvas.setStrokeStyle(ctx)("#CCC")();
                              Effect.foreachE(Data_Array.range(0)(50))(function (i) {
                                  return Graphics_Canvas.strokePath(ctx)(function __do() {
                                      Graphics_Canvas.moveTo(ctx)(Data_Int.toNumber((Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(s.canvas.width)(2) - 50 | 0) - (i * 3 | 0) | 0))(Data_Int.toNumber((s.canvas.height - 50 | 0) + i | 0))();
                                      Graphics_Canvas.lineTo(ctx)(Data_Int.toNumber((Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(s.canvas.width)(2) + 50 | 0) + (i * 3 | 0) | 0))(Data_Int.toNumber((s.canvas.height - 50 | 0) + i | 0))();
                              ...
                              (function () {
                                  if (s.game.gameStatus instanceof Playing) {
                                      if (s.game.keyFlag) {
                                          if (s.images.rocket instanceof Data_Maybe.Just) {
                                              var w = Web_HTML_HTMLImageElement.naturalWidth(s.images.rocket.value0)();
                                              var h = Web_HTML_HTMLImageElement.naturalHeight(s.images.rocket.value0)();
                                              var x = Data_Int.toNumber(s.canvas.width) / 2.0;
                                              var y = Data_Int.toNumber(s.canvas.height - 50 | 0) - s.game.altitude;
                                              Graphics_Canvas.setLineWidth(ctx)(2.0)();
                                              Effect.foreachE(Data_Array.range(0)(9))(function (i) {
                                                  return function __do() {
                                                      Graphics_Canvas.setStrokeStyle(ctx)(mkColor(255)(i * 20 | 0)(0))();
                                                      return Graphics_Canvas.strokePath(ctx)(Graphics_Canvas.arc(ctx)({
                                                          x: x,
                                                          y: y,
                                                          radius: Data_Int.toNumber(i),
                                                          start: 0.0,
                                                          end: 2.0 * $$Math.pi
                                                      }))();
                                                  };
                                          ...
                                          throw new Error("Failed pattern match at MoonLander (line 317, column 13 - line 337, column 26): " + [ s.images.rocket.constructor.name ]);
                                      };
                                      return Data_Unit.unit;
                                  };
                                  return Data_Unit.unit;
                              ...
                              (function () {
                                  if (s.images.rocket instanceof Data_Maybe.Just) {
                                      var w = Web_HTML_HTMLImageElement.naturalWidth(s.images.rocket.value0)();
                                      var h = Web_HTML_HTMLImageElement.naturalHeight(s.images.rocket.value0)();
                                      var x = (Data_Int.toNumber(s.canvas.width) - Data_Int.toNumber(w)) / 2.0;
                                      var y = Data_Int.toNumber((s.canvas.height - 50 | 0) - h | 0) - s.game.altitude;
                                      var angle = (function () {
                                          if (s.game.gameStatus instanceof GameOver) {
                                              if (s.game.gameStatus.value0 instanceof Success) {
                                                  return 0.0;
                                              };
                                              if (s.game.gameStatus.value0 instanceof Failure) {
                                                  return 50.0;
                                              };
                                              throw new Error("Failed pattern match at MoonLander (line 353, column 44 - line 355, column 40): " + [ s.game.gameStatus.value0.constructor.name ]);
                                          };
                                          return 0.0;
                                      })();
                                      drawRocket(ctx)(s.images.rocket.value0)(x)(y)(Data_Int.toNumber(w))(Data_Int.toNumber(h))(angle)();
                                      return Data_Unit.unit;
                                  };
                                  if (s.images.rocket instanceof Data_Maybe.Nothing) {
                                      return Data_Unit.unit;
                                  };
                                  throw new Error("Failed pattern match at MoonLander (line 344, column 7 - line 360, column 20): " + [ s.images.rocket.constructor.name ]);
                              })();
                              ...
                              (function () {
                                  ...
                                  return Graphics_Canvas.fillText(ctx)("speed: " + (Data_Number_Format.toStringWith(Data_Number_Format.fixed(3))(s.game.speed) + " km/h"))(20.0)(50.0)();
                              })();
                              var textAlign = Graphics_Canvas.textAlign(ctx)();
                              Graphics_Canvas.setTextAlign(ctx)(Graphics_Canvas.AlignCenter.value)();
                              Graphics_Canvas.setFont(ctx)("bold 42px \"\u30d2\u30e9\u30ae\u30ce\u4e38\u30b4 ProN W4\", \"Hiragino Maru Gothic ProN\", Meiryo, Arial, sans-serif")();
                              drawText(ctx)("Moon Lander")(Data_Int.toNumber(s.canvas.width) / 2.0)(140.0)("#ff0")("#000")(6.0)();
                              var showHitSpace = function __do() {
                                  Graphics_Canvas.setFont(ctx)("bold 36px \"\u30d2\u30e9\u30ae\u30ce\u4e38\u30b4 ProN W4\", \"Hiragino Maru Gothic ProN\", Meiryo, Arial, sans-serif")();
                                  return drawText(ctx)("Hit Space Key")(Data_Int.toNumber(s.canvas.width) / 2.0)(240.0)("#7f7")("#000")(6.0)();
                              };
                              var showGameOver = function __do() {
                                  Graphics_Canvas.setFont(ctx)("bold 42px \"\u30d2\u30e9\u30ae\u30ce\u4e38\u30b4 ProN W4\", \"Hiragino Maru Gothic ProN\", Meiryo, Arial, sans-serif")();
                                  return drawText(ctx)("GAME OVER")(Data_Int.toNumber(s.canvas.width) / 2.0)(340.0)("#f77")("#000")(6.0)();
                              };
                              var showGameClear = function __do() {
                                  Graphics_Canvas.setFont(ctx)("bold 42px \"\u30d2\u30e9\u30ae\u30ce\u4e38\u30b4 ProN W4\", \"Hiragino Maru Gothic ProN\", Meiryo, Arial, sans-serif")();
                                  return drawText(ctx)("GAME CLEAR")(Data_Int.toNumber(s.canvas.width) / 2.0)(340.0)("#0ff")("#000")(6.0)();
                              };
                              (function () {
                                  if (s.game.gameStatus instanceof Opening) {
                                      return showHitSpace();
                                  };
                                  if (s.game.gameStatus instanceof GameOver && s.game.gameStatus.value0 instanceof Success) {
                                      return showGameClear();
                                  };
                                  if (s.game.gameStatus instanceof GameOver && s.game.gameStatus.value0 instanceof Failure) {
                                      return showGameOver();
                                  };
                                  return Data_Unit.unit;
                              })();
                              Graphics_Canvas.setTextAlign(ctx)(textAlign)();
                              var v2 = Graphics_Canvas.getCanvasElementById("canvas")();
                              if (v2 instanceof Data_Maybe.Just) {
                                  var ctx2 = Graphics_Canvas.getContext2D(v2.value0)();
                                  Graphics_Canvas.drawImage(ctx2)(Graphics_Canvas.canvasElementToImageSource(v1.value0))(0.0)(0.0)();
                                  return Data_Unit.unit;
                              };
                              throw new Error("Failed pattern match at MoonLander (line 398, column 7 - line 398, column 55): " + [ v2.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at MoonLander (line 284, column 7 - line 284, column 61): " + [ v1.constructor.name ]);
                      }));
                  });
              };
              throw new Error("Failed pattern match at MoonLander (line 205, column 16 - line 402, column 16): " + [ v.constructor.name ]);
          };
      };
  };
  var doLoop = function (dictMonadAff) {
      return function (dictMonadEffect) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Time_Duration.Milliseconds(1000.0 / 60.0))))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                  var acceleration = (function () {
                      var $100 = s.game.altitude < 300.0;
                      if ($100) {
                          if (s.game.keyFlag) {
                              return 0.25;
                          };
                  ...
                  var speed = s.game.speed + acceleration;
                  var altitude = s.game.altitude + speed;
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $105 = {};
                      for (var $106 in st) {
                      ...
                      $105.game = (function () {
                          var $102 = {};
                          for (var $103 in st.game) {
                              if ({}.hasOwnProperty.call(st.game, $103)) {
                                  $102[$103] = st["game"][$103];
                              };
                          };
                          $102.acceleration = acceleration;
                          $102.speed = speed;
                          $102.altitude = altitude;
                          return $102;
                      })();
                      return $105;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(Draw.value))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s1) {
                              if (s1.game.gameStatus instanceof Playing) {
                                  var $109 = s1.game.altitude <= 0.0;
                                  if ($109) {
                                      var result = (function () {
                                          var $110 = s1.game.speed >= -2.0;
                                          if ($110) {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                          ...
                                          $114.game = (function () {
                                              var $111 = {};
                                              for (var $112 in st.game) {
                                                  if ({}.hasOwnProperty.call(st.game, $112)) {
                                                      $111[$112] = st["game"][$112];
                                                  };
                                              };
                                              $111.gameStatus = new GameOver(result, Waiting.value);
                                              return $111;
                                          })();
                                          return $114;
                                      }))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(Draw.value))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Time_Duration.Milliseconds(500.0))))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                      var $120 = {};
                                                      for (var $121 in st) {
                                                      ...
                                                      $120.game = (function () {
                                                          var $117 = {};
                                                          for (var $118 in s1.game) {
                                                              if ({}.hasOwnProperty.call(s1.game, $118)) {
                                                                  $117[$118] = s1["game"][$118];
                                                              };
                                                          };
                                                          $117.gameStatus = new GameOver(result, Ready.value);
                                                          return $117;
                                                      })();
                                                      return $120;
                                                  }))(function () {
                                  ...
                                  return doLoop(dictMonadAff)(dictMonadAff.MonadEffect0());
                              };
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                          });
                      });
...
(function($PS) {
  ...
  var MoonLander = $PS["MoonLander"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(MoonLander.component(Effect_Aff_Class.monadAffAff)(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();